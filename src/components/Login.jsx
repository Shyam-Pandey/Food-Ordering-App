...
const Login = () => {
    ...
    return (
        <form action="" onSubmit={(e) => e.preventDefault()}
            ...
            <main className='flex flex-col justify-center items-center w-[22rem] h-[23rem] text-white bg-green-200 mt-16  rounded-md '>
                <h1 className='text-black -ml-60 mb-5'> {isLoggedIn ? "Sign In" : "Sign up"}</h1>
                {!isLoggedIn &&
                    <input
                        ref={fullName}
                        type="text"
                        ...
                        className='w-[80%] h-10 rounded-lg p-2 m-3 outline-none text-black'
                ...
                <button
                    onClick={handleLogin}
                    className='w-[80%] h-10 rounded-lg m-3 bg-cyan-400'
                >
