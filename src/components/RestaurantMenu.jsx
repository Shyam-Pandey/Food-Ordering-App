...
const RestaurantMenu = () => {
    ...
    const { name, cuisines, city, areaName, totalRatingsString, avgRating } = restaurantInfo?.cards[2]?.card?.card?.info;

    const items = restaurantInfo?.cards[4]?.groupedCard?.cardGroupMap?.REGULAR.cards
    ...
    return (
        <div className='flex flex-col gap-3 justify-center mx-10 sm:mx-32 md:mx-36 lg:mx-44 xl:mx-72 my-12'>
